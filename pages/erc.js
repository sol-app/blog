...
export default function Home({ posts }) {
    return (
        ...
        <div className="w-full mx-auto md:prose-lg px-8 mb-1">
            ...
            <h2 className='backdrop-blur-sm text-blue-600 bg-white/30'>Ethereum Improvement Proposals : <span className='text-white'>EIP</span></h2>
            <p className='text-sky-700'>ERC 165 &middot; ERC 20 &middot; ERC 721 &middot; ERC 1155</p>
            </div>
